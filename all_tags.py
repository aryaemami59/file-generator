...
meta_tag_3 = "\t\t<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" />\n"
...
def basic(middle=[], end=[]):
    html_boilerplate_first_half = [
        doctype_html, html_tag_open, head_tag_open, meta_tag_1, meta_tag_2, meta_tag_3]
    html_boilerplate_second_half = [*middle,
                                    title_tag, head_tag_close, body_tag_open, child_of_body_tag, *end, body_tag_close, html_tag_close]
